...
namespace Zombera.Data
{
    ...
    public sealed class WeaponData : ScriptableObject
    {
        ...
        [Header("Handling")] [Tooltip("World-space recoil impulse applied to the camera/character per shot.")]
        public float recoilForce = 0.3f;

        [Tooltip("Maximum bullet spread half-angle in degrees at effective range.")] [Range(0f, 45f)]
        public float spreadAngle = 2f;

        [Tooltip("Seconds from reload start to chamber-ready.")] [Min(0f)]
        public float reloadTimeSeconds = 1.5f;
        ...
        [Tooltip("Optional bow tuning override used when this weapon category is Bow.")]
        public BowWeaponData bowWeaponData;
    }
}