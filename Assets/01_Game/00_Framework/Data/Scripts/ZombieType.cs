...
namespace Zombera.Data
{
    ...
    public sealed class ZombieType : ScriptableObject
    {
        ...
        [Header("Perception")] [Tooltip("Overrides the zombie's detection range. 0 = use prefab default.")]
        ...
        [Header("Horde")] [Tooltip("0 = lone wolf, 1 = always joins a horde when spawned together.")] [Range(0f, 1f)]
