...
namespace Zombera.Data
{
    ...
    {
        [Tooltip("Minimum game-phase index required for this entry to be active (0 = always).")] [Min(0)]
        public int minGamePhase;

        [Tooltip("Region ID filter. Leave empty to match any region.")]
        public string regionId;

        [Tooltip("Maximum difficulty that allows this entry. 0 = no difficulty cap.")] [Min(0f)]
