...
namespace Zombera.Debugging
{
    ...
    {
        [Header("Visual Flags")] public bool showAIStates = true;

        public bool showDetectionRadius = true;
        public bool showPathfinding = true;

        [Header("Tool Toggles")] public bool enableSpawnTools = true;
        ...
        [Header("Tuning")] [Range(0.05f, 1f)] public float slowMotionScale = 0.2f;

        [Header("Per-System Debug Channels")] public bool debugCombat;

        public bool debugWorld;
        public bool debugSquad;
        public bool debugSave;

        [Header("Profile Presets")] public bool useLightweightProfile;
