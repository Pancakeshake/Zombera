...
namespace Zombera.UI
{
    ...
    public sealed class SquadMemberRowView : MonoBehaviour
    {
        ...
        public void Bind(SquadMemberViewData data)
        {
            ...
            if (healthBar != null) healthBar.value = data.health01;

            if (selectionHighlight != null) selectionHighlight.enabled = data.isSelected;

            if (downedIndicator != null) downedIndicator.enabled = data.isDowned;
        }
    }
}