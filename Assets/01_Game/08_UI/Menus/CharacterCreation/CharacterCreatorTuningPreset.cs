...
namespace Zombera.UI.Menus.CharacterCreation
{
    ...
    {
        [Header("Canvas")] public Vector2 canvasReferenceResolution = new(768f, 1365f);

        [Range(0f, 1f)] public float canvasMatchWidthOrHeight = 0.5f;

        [Header("Controller")] public bool enableRuntimeCustomizationUi = true;

        public Color panelTint = new(0.05f, 0.04f, 0.04f, 0.88f);
        public Color tabNormalTint = new(0.13f, 0.12f, 0.12f, 0.96f);
        public Color tabActiveTint = new(0.45f, 0.18f, 0.09f, 0.99f);
        public Vector2 panelAnchorMin = new(0.14f, 0.06f);
        public Vector2 panelAnchorMax = new(0.86f, 0.95f);
        public float panelInnerPadding = 18f;
        public float panelSpacing = 12f;
        public float rowSpacing = 10f;
        public bool autoFramePreviewCamera;

        [Header("Title")] public float titlePreferredHeight = 52f;

        public float titleFontSize = 23f;

        [Header("Gender Row")] public float raceRowPreferredHeight = 56f;
        ...
        [Header("Tab Row")] public float tabRowPreferredHeight = 48f;

        public float tabRowSpacing = 2f;
        public float tabButtonPreferredHeight = 44f;
        public float tabLabelFontSize = 18f;

        [Header("Body Tab")] public float bodySelectorRowPreferredHeight = 64f;
