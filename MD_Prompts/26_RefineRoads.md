# 26 — Refine Roads Against Terrain

| Field | Value |
|-------|-------|
| Registry order | 26 |
| StageId | `RefineRoadsAgainstTerrain` |
| Section | Roads |
...
- Symptom: Roads refined against pre-pad terrain.
- Wrong path: Skipping Refine after ApplyCityPads (Invalidates target).
- Correct: Always re-run after pads.
- Status: open
